namespace GoogleReaderNotifierPlugin
{
  partial class Config
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.textItemInterval = new System.Windows.Forms.TextBox();
      ...
      this.label5.Text = "Check for feed updates every:";
      // 
      // label6
      // 
      ...
      this.label6.Text = "Show new items for:";
      // 
      // textCheckInterval
      // 
      ...
      // textUser
      // 
      this.textUser.Location = new System.Drawing.Point(112, 12);
      ...
      // textPassword
      // 
      this.textPassword.Location = new System.Drawing.Point(112, 38);
      ...
      this.Controls.Add(this.textItemInterval);
      ...
      this.Text = "Feed notifier configuration";
    ...
    private System.Windows.Forms.TextBox textItemInterval;
